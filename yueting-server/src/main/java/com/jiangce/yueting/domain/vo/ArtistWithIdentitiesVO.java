...
@NoArgsConstructor
@AllArgsConstructor
public class ArtistWithIdentitiesVO {
    ...
    public ArtistInfoVO toArtistInfoVO() {
        return new ArtistInfoVO(artistId, artistName, artistAvatarUrl, artistCoverUrl, gender, language, artistBio, artistDescription, identities, createdAt, status);
    }
}
