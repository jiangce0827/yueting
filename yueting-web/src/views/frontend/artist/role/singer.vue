		...
		<div class="auth-card">
			...
			<el-form label-width="100px" label-position="left">
				<el-form-item label="歌曲类型：" required>
					<el-radio-group v-model="songType">
						<el-radio :value="0">原唱</el-radio>
				...
				<el-form-item label="歌曲简介：" required>
					<el-input
...
<script setup>
	...
	const canSubmit = computed(() => {
		return (
			fileUrl.value && songType.value !== null && songName.value.trim() && introduction.value.trim()
		);
	});
